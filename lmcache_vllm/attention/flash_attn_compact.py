...
def flash_attn_forward_compact(
    self,
    query: torch.Tensor,
    key: torch.Tensor,
    value: torch.Tensor,
    ...
    if prefill_meta := attn_metadata.prefill_metadata:
        ...
        if (kv_cache is None or prefill_meta.block_tables is None
            ...
            # NOTE(Jiayi): skip warmup
            if attn_metadata.seq_lens[0] != 128:  
                import pdb
                pdb.set_trace()
    ...
    if decode_meta := attn_metadata.decode_metadata:
        ...
        # NOTE(Jiayi): The following code causes cuda graph fails
        #if attn_metadata.slot_mapping[0] != -1:
        #    import pdb
        #    pdb.set_trace()
...
def inject_flash_attn_compact():
    import vllm.attention.backends.flash_attn
    vllm.attention.backends.flash_attn.FlashAttentionImpl.forward = flash_attn_forward_compact